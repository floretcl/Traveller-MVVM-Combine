...
struct UnauthorizedLocationNav: View {
        ...
        ZStack {
            ...
            VStack {
                HStack {
                    ...
                    Text("Enable localization in your iPhone settings")
                        .font(.headline)
                    Spacer()
                }.padding()
                Spacer()
...
struct UnauthorizedLocationNav_Previews: PreviewProvider {
